...
public class NationController extends AppCompatActivity {
    EditText edit;
    ...
    public void getSuccessStory(String nation) throws IOException {
        ...
        String queryUrl="http://apis.data.go.kr/B410001/natnInfoService/natnInfo?ServiceKey=" + key + "&type=xml&numOfRows=1&search1=" + nation;
