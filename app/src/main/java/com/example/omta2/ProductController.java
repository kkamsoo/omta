...
public class ProductController extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.myAlertBuilder = new AlertDialog.Builder(ProductController.this);
    ...
    public void getSuccessStory(String nation) throws IOException {
        ...
        String queryUrl="http://apis.data.go.kr/B410001/cmmdtDbService/cmmdtDb?ServiceKey=" + key + "&type=xml&numOfRows=1&search1=" + nation;
